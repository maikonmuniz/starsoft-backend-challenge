...
export class ItemDto {
  ...
  @ApiProperty({ example: 10.0, description: 'price the item' })
  price: number;
}
...
export class OrderDto {
  ...
  @ApiProperty({
    example: 'Generate order',
    description: 'description the order!',
  })
  description: string;
  ...
  @ApiProperty({ example: '1', description: 'quantity itens' })
  quantity: number;
